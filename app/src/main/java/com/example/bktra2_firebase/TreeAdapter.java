...
public class TreeAdapter extends FirebaseRecyclerAdapter<Tree, TreeAdapter.myViewHolder> {
     ...
     * @param options
     */
    public TreeAdapter(@NonNull FirebaseRecyclerOptions<Tree> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull myViewHolder holder, final int position, @NonNull Tree model) {
